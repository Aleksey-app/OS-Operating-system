...
-  &#9989; Вариант функции exec() "int execlp(const char *file, const char *arg, ...)"
-  &#9989; При реализации задания необходимо учесть особенности варианта функции execlp() настроить переменную PATH.
